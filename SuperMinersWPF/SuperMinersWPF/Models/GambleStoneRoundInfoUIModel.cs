...
namespace SuperMinersWPF.Models
{
    ...
    {
        //private BitmapSource[] _winnedColors = new BitmapSource[64];
        ...
        public GambleStoneRoundInfo ParentObject
        {
            ...
            {
                _parentObject = value;
                //_winnedColors = new BitmapSource[this._parentObject.WinColorItems.Length];
                RefreshUI();
            }
        }
        ...
        public void SetWinnedInningColor(int index, GambleStoneItemColor color)
        {
            if (index >= 0 && index < this._parentObject.WinColorItems.Length)
            {
                ...
                switch (color)
                {
                    case GambleStoneItemColor.Red:
                        this._parentObject.CurrentWinRedCount++;
                        break;
                    case GambleStoneItemColor.Green:
                        this._parentObject.CurrentWinGreenCount++;
                        break;
                    case GambleStoneItemColor.Blue:
                        this._parentObject.CurrentWinBlueCount++;
                        break;
                    case GambleStoneItemColor.Purple:
                        this._parentObject.CurrentWinPurpleCount++;
                        break;
                    default:
                        break;
                }
                ...
                //NotifyPropertyChange("WinnedInning1ColorImg" + (index + 1));
