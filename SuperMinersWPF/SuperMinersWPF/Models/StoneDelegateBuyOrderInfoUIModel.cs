...
namespace SuperMinersWPF.Models
{
    public class StoneDelegateBuyOrderInfoUIModel : BaseModel
    {
        ...
        private StoneDelegateBuyOrderInfo _parentObject = new StoneDelegateBuyOrderInfo();
        ...
        public StoneDelegateBuyOrderInfo ParentObject
        {
            ...
            set
            {
                ...
                NotifyPropertyChange("PayButtonVisible");
            }
        }
        ...
        public Visibility PayButtonVisible
        {
            get
            {
                if (this.BuyState == StoneDelegateBuyState.NotPayed)
                {
