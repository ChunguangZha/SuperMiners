...
namespace SuperMinersServerApplication.WebServiceToWeb.Contracts
{
    public partial interface IServiceToWeb
    {
        ...
        [OperationContract]
        OperResultObject BindWeiXinUser(string wxUserOpenID, string wxUserName, string xlUserLoginName, string xlUserPassword, string ip);
        ...
        /// <returns></returns>
        [OperationContract]
        int RegisterUserFromWeiXin(string wxUserOpenID, string wxUserName, string clientIP, string userLoginName, string userName, string password,
