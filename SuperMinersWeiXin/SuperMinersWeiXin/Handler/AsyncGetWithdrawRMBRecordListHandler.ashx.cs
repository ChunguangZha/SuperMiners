...
{
    /// <summary>
    /// Summary description for AsyncGetWithdrawRMBRecordListHandler
    /// </summary>
    public class AsyncGetWithdrawRMBRecordListHandler : IHttpAsyncHandler
    {
        ...
        public IAsyncResult BeginProcessRequest(HttpContext context, AsyncCallback cb, object extraData)
        {
            try
            {
                ...
                MyGetNotFinishedSellStoneAsyncResult asyncResult = new MyGetNotFinishedSellStoneAsyncResult(context, cb, () =>
                {
                    ...
                    return WcfClient.Instance.GetWithdrawRMBRecordList(xlUserName, pageitemcount, pageindex);
                },
                xlUserName);
            ...
            {
                LogHelper.Instance.AddErrorLog("AsyncGetWithdrawRMBRecordListHandler.BeginProcessRequest Exception", exc);
                return null;
            }
        }
        ...
        public void EndProcessRequest(IAsyncResult result)
        {
            try
            {
                ...
                {
                    LogHelper.Instance.AddErrorLog("AsyncGetWithdrawRMBRecordListHandler.GetResult Exception", myresult.Exception);
                ...
                {
                    WithdrawRMBRecord[] orders = myresult.Result as WithdrawRMBRecord[];
            ...
            {
                LogHelper.Instance.AddErrorLog("AsyncGetWithdrawRMBRecordListHandler.EndProcessRequest Exception", exc);
            }
        }
    }
}