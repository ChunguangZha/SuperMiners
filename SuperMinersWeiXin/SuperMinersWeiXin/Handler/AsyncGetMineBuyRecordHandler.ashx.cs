...
{
    /// <summary>
    /// Summary description for AsyncGetMineBuyRecordHandler
    /// </summary>
    public class AsyncGetMineBuyRecordHandler : IHttpAsyncHandler
    {
        ...
        public IAsyncResult BeginProcessRequest(HttpContext context, AsyncCallback cb, object extraData)
        {
            try
            {
                ...
                MyGetNotFinishedSellStoneAsyncResult asyncResult = new MyGetNotFinishedSellStoneAsyncResult(context, cb, () =>
                {
                    ...
                    return WcfClient.Instance.GetBuyMineFinishedRecordList(xlUserName, pageitemcount, pageindex);
                },
                xlUserName);
            ...
            {
                LogHelper.Instance.AddErrorLog("AsyncGetMineBuyRecordHandler.BeginProcessRequest Exception", exc);
                return null;
            }
        }
        ...
        public void EndProcessRequest(IAsyncResult result)
        {
            try
            {
                ...
                {
                    LogHelper.Instance.AddErrorLog("AsyncGetMineBuyRecordHandler.GetResult Exception", myresult.Exception);
                ...
                {
                    MinesBuyRecord[] orders = myresult.Result as MinesBuyRecord[];
            ...
            {
                LogHelper.Instance.AddErrorLog("AsyncGetMineBuyRecordHandler.EndProcessRequest Exception", exc);
            }
        }
    }
}