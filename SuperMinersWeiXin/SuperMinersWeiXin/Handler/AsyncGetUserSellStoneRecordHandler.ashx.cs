...
{
    /// <summary>
    /// Summary description for AsyncGetUserSellStoneRecordHandler
    /// </summary>
    public class AsyncGetUserSellStoneRecordHandler : IHttpAsyncHandler
    {
        ...
        public IAsyncResult BeginProcessRequest(HttpContext context, AsyncCallback cb, object extraData)
        {
            try
            {
                ...
                MyGetNotFinishedSellStoneAsyncResult asyncResult = new MyGetNotFinishedSellStoneAsyncResult(context, cb, () =>
                {
                    ...
                    return WcfClient.Instance.GetUserSellStoneOrders(xlUserName, pageitemcount, pageindex);
                },
                xlUserName);
            ...
            {
                LogHelper.Instance.AddErrorLog("AsyncGetUserSellStoneRecordHandler.BeginProcessRequest Exception", exc);
                return null;
            }
        }
        ...
        public void EndProcessRequest(IAsyncResult result)
        {
            try
            {
                ...
                {
                    LogHelper.Instance.AddErrorLog("AsyncGetUserSellStoneRecordHandler.GetResult Exception", myresult.Exception);
            ...
            {
                LogHelper.Instance.AddErrorLog("AsyncGetUserSellStoneRecordHandler.EndProcessRequest Exception", exc);
            }
        }
    }
}