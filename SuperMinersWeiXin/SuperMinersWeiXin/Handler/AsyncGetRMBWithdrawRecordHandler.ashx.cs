...
{
    /// <summary>
    /// Summary description for AsyncGetRMBWithdrawRecordHandler
    /// </summary>
    public class AsyncGetRMBWithdrawRecordHandler : IHttpAsyncHandler
    {
        ...
        public IAsyncResult BeginProcessRequest(HttpContext context, AsyncCallback cb, object extraData)
        {
            ...
            {
                LogHelper.Instance.AddErrorLog("AsyncGetRMBWithdrawRecordHandler.BeginProcessRequest Exception", exc);
                return null;
            }
        }
        ...
        public void EndProcessRequest(IAsyncResult result)
        {
            try
            {
                ...
                {
                    LogHelper.Instance.AddErrorLog("AsyncGetRMBWithdrawRecordHandler.GetResult Exception", myresult.Exception);
            ...
            {
                LogHelper.Instance.AddErrorLog("AsyncGetRMBWithdrawRecordHandler.EndProcessRequest Exception", exc);
            }
        }
    }
}